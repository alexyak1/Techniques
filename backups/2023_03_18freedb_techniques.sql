...
-- Время создания: Мар 18 2023 г., 13:49
...
INSERT INTO `blog_items` (`id`, `title`, `date`) VALUES
(1, 'KRAKOW WORLD CHAMPIONSHIPS VETERANS', '2022 Poland September 8-11');

-- --------------------------------------------------------

--
-- Структура таблицы `blog_pool_answers`
--
...
--
-- Дамп данных таблицы `blog_pool_answers`
--

INSERT INTO `blog_pool_answers` (`id`, `blog_item_id`, `name`, `votes`) VALUES
(1, 1, 'O-Goshi', 0),
(2, 1, 'Tomoe-nage', 0),
(3, 1, 'Yko-tomoe-nage', 0),
(4, 1, 'Hisa-guruma', 0);
...
--
-- Индексы таблицы `blog_pool_answers`
--
...
--
-- AUTO_INCREMENT для таблицы `blog_pool_answers`
--
ALTER TABLE `blog_pool_answers`
